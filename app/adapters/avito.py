...
async def _access_token() -> str:
    return await ensure_fresh_access(
        ...
        use_basic_auth=True,  # Avito — BasicAuth
    )


async def send_message(negotiation_id: str, text: str) -> None:
...
async def mark_read(negotiation_id: str) -> None:
    access = await _access_token()
